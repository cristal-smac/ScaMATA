...
object LargeScaleTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    for (m <- 2 to 500 by 2) {
      ...
      var (distributedGiftSolverRule, distributedSwapSolverRule, distributedGiftSolverTime, distributedSwapSolverTime) =
        (List[Double](), List[Double](), List[Double](), List[Double]())
      var (nbPropose4gift, nbCounterPropose4gift, nbAccept4gift, nbReject4gift, nbWithdraw4gift, nbConfirmGift4gift, nbConfirmSwap4gift, nbInform4gift,
