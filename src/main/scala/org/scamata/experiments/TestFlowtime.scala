  ...
  val debug= false
    ...
    def main(args: Array[String]): Unit = {
      ...
      bw.write(s"m,n," +
        ...
        s"minExhaustiveSolverTime,openExhaustiveSolverTime,meanExhaustiveSolverTime,closedExhaustiveSolverTime,maxExhaustiveSolverTime," +
      ...
      for (m <- 2 to 100) {
        for (n <- 10*m to 10*m) {
          ...
          var (lpSolverRule, giftSolverRule, distributedGiftSolverRule, exhaustiveSolverRule,
          lpSolverTime, lpSolverPreTime, lpSolverPostTime, giftSolverTime, exhaustiveSolverTime, distributedGiftSolverTime,
