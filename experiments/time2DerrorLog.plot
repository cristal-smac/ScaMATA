...
set output 'figures/time2DerrorFlowtimeLog.pdf'
set xlabel "m workers (5m tasks)"
plot "data/flowtime.csv" using 1:($34)/1E9:($36)/1E9 with filledcurves lc "light-green" notitle,\
     ...
     "data/flowtime.csv" using 1:($29)/1E9:($31)/1E9 with filledcurves lc "light-blue" notitle,\
