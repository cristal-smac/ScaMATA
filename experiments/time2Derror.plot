...
plot "data/flowtime.csv" using 1:($39)/1E9:($41)/1E9 with filledcurves lc "light-red" notitle,\
     "data/flowtime.csv" using 1:($40)/1E9 with lines dt 5 lc "dark-red" title 'LP',\
