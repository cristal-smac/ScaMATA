...
plot  "data/flowtime.csv" using 1:71 with lines dt 1 lc "dark-blue" title 'nb. of gifts  for the strategy Gift',\
       "data/flowtime.csv" using 1:79 with lines dt 3 lc "dark-green" title 'nb. of gifts for the strategy Swap',\
       "data/flowtime.csv" using 1:80 with lines dt 5 lc "dark-red" title 'nb. of swaps for the strategy Swap'
